    ...
    return (
        ...
        <main className="bg-cyan-900">
            <div className="container">
                ...
                <div className="py-10">
                    <h2 className="text-4xl mb-1 font-bold text-center text-white">
                        What do you want your resume to look like?
                    </h2>
                    <p className="text-white text-lg text-center after:w-20 after:h-1.5 after:bg-white after:block after:mx-auto after:my-4 after:rounded-full">
                        View all resume templates and select a specific style to customize
                    </p>

                    <div className="grid xl:grid-cols-3 md:grid-cols-2 gap-10 mt-10 text-px11">
